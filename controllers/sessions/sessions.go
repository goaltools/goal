...
func (c *Sessions) Initially(w http.ResponseWriter, r *http.Request, a []interface{}) bool {
...
func (c *Sessions) Finally(w http.ResponseWriter, r *http.Request, a []interface{}) bool {
