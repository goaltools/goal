...
func (c *Controller) Initially(w http.ResponseWriter, r *http.Request, a []interface{}) bool {
	return false
}

// Finally is a magic method that is executed after every request.
func (c *Controller) Finally(w http.ResponseWriter, r *http.Request, a []interface{}) bool {
	return false
}
